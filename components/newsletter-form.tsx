...
// All countries with their dial codes (sorted alphabetically)
const COUNTRIES = [
...
export function NewsletterForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const fullPhoneNumber = selectedCountry ? `${selectedCountry.dial}${formData.phoneNumber}` : formData.phoneNumber
      ...
      if (response.ok) {
        ...
        setFormData({ name: "", email: "", ethereumAddress: "", phoneNumber: "", countryCode: "US" })
        generateCaptcha()
      } else {
        setStatus("error")

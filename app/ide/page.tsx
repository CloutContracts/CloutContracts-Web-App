...
import { AuthButtons } from "@/components/auth-provider"
import Image from "next/image"
import Link from "next/link"
import { Users, BarChart3, Mail, Settings, ArrowLeft } from "lucide-react"
          ...
          {isMobileMenuOpen && (
            <div className="xl:hidden mt-4 pb-4 border-t border-border">
              <nav className="flex flex-col gap-3 pt-4">
                ...
                <Link
                  href="/"
                  className="text-muted-foreground hover:text-foreground transition-colors flex items-center gap-2 text-sm py-2 sm:hidden"
                >
                  <ArrowLeft className="w-4 h-4" />
                  Back to Home
                </Link>
